...
Define the email notification capability: SMTP infrastructure, Thymeleaf templates, and the triggering rules for registration verification, quota-exceeded notices, and webhook permanent-failed notices.
