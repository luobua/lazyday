...
Define the webhook delivery capability: tenant webhook configuration, secret rotation, domain event publication, event materialization, scheduled outbound delivery with retries, HMAC signing, and the test push utility.
