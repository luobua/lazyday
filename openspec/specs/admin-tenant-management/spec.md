...
Define the platform-admin tenant management capability: tenant listing, detail, suspension/resumption lifecycle, platform overview metrics, and the corresponding Admin Console UI.
