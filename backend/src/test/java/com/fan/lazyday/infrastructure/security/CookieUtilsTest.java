...
class CookieUtilsTest {
    ...
    @Nested
    @DisplayName("开发环境（无 SPRING_PROFILES_ACTIVE）")
    class DevEnvironment {

        @Test
        @DisplayName("createAccessTokenCookie: dev 环境不设 Secure")
        void createAccessTokenCookie_dev_noSecure() {
        ...
        @Test
        @DisplayName("createRefreshTokenCookie: dev 环境不设 Secure")
        void createRefreshTokenCookie_dev_noSecure() {
        ...
        @Test
        @DisplayName("createCsrfTokenCookie: CSRF cookie 应不设 httpOnly")
        ...
        @Test
        @DisplayName("clearCookie: maxAge 应为 0")
